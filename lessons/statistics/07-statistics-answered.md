...
In very basic terms, it could be said that Bayesian statistics deals with data that changes or updates as the analysis is occurring, therefore changing the analysis, while frequentist statistics deals with unchanging, past data. Another simple way to think about the difference is that Bayesian statistics is more focused on plausibility of an outcome, whereas frequentist focuses on the frequency of an outcome.
